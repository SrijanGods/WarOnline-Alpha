...
namespace ThirdPersonCamera
{
    public class Follow : MonoBehaviour
    {
        ...
        public bool lookBackwardse = true;
        ...
        void Update()
        {
            if (follow)
            {
                ...
                Quaternion toRotation = Quaternion.LookRotation((!lookBackwardse ? cc.target.transform.forward + tiltVector : -cc.target.transform.forward + tiltVector), Vector3.up);
