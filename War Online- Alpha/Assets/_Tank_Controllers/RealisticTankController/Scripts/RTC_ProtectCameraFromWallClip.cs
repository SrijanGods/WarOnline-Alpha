...
[AddComponentMenu("BoneCracker Games/Realistic Tank Controller/Camera/Protect Camera From Wall Clip")]
public class RTC_ProtectCameraFromWallClip : MonoBehaviour
{
...
private RTC_MainCamera RTCCamera;
    ...
    private void LateUpdate()
    {
		...
		if (RTCCamera.cameraMode != RTC_MainCamera.CameraMode.ORBIT) {
        ...
        var cols = Physics.OverlapCapsule(m_Ray.origin, startPoint.position , sphereCastRadius);
