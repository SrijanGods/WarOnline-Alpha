...
namespace UnityToolbag
{
    ...
    public abstract class CacheBehaviour : MonoBehaviour
    {
        ...
        /// </summary>
        public new Text guiText { get { return _guiText ? _guiText : (_guiText = GetComponent<Text>()); } }

        [HideInInspector, NonSerialized]
        private Texture _guiTexture;

        /// <summary>
        /// Gets the GUITexture attached to the object.
        /// </summary>
        public new Texture guiTexture { get { return _guiTexture ? _guiTexture : (_guiTexture = GetComponent<Texture>()); } }
        ...
        /*[HideInInspector, NonSerialized]
        private NetworkIdentity _networkView;

        /// <summary>
        /// Gets the NetworkView attached to the object.
        /// </summary>
        public new NetworkIdentity networkView { get { return _networkView ? _networkView : (_networkView = GetComponent<NetworkIdentity>()); } }*/
