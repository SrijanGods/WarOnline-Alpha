...
namespace Obi
{
	...
	public class ObiDistanceFieldRenderer : MonoBehaviour
	{
		...
		public void OnDrawGizmos(){
			if (collider != null && collider.distanceField != null && collider.distanceField.Initialized && material != null){
				DrawCutawayPlane(collider.distanceField,transform.localToWorldMatrix);
				Gizmos.color = boundsColor;
				Gizmos.DrawWireCube(collider.distanceField.FieldBounds.center,collider.distanceField.FieldBounds.size);
			}
		}
